...
secret_float = os.getenv('secret_float')
secret_int = os.getenv('secret_int')
secret_list_int = os.getenv('secret_list_int')
secret_list_str = os.getenv('secret_list_str')
secret_string = os.getenv('secret_string')
secret_string_with_comment = os.getenv('secret_string_with_comment')
...
conf_string = conf_string = 'conf_string value'
conf_string_with_comment = conf_string_with_comment = 'conf_string value'
conf_int = conf_int = 1
...
print('secret_string: ' + str(secret_string) + ' type: ' + str(type(secret_string)))
print('secret_string_with_comment: ' + str(secret_string_with_comment) + ' type: ' + str(type(secret_string_with_comment)))
print('secret_int: ' + str(secret_int) + ' type: ' + str(type(secret_int)))
print('secret_float: ' + str(secret_float) + ' type: ' + str(type(secret_float)))
print('secret_list_int: ' + str(secret_list_int) + ' type: ' + str(type(secret_list_int)))
print('secret_list_str: ' + str(secret_list_str) + ' type: ' + str(type(secret_list_str)))
...
check = secret_string
if not isinstance(check, str):
    print('secret_string is not a string. It is a ' + str(type(check)))
    exit(1)
check = secret_string_with_comment
if not isinstance(check, str):
    print('secret_string_with_comment is not a string. It is a ' + str(type(check)))
    exit(1)
check = secret_int
if not isinstance(check, int):
    print('secret_int is not an int. It is a ' + str(type(check)))
    exit(1)
check = secret_float
if not isinstance(check, float):
    print('secret_float is not a float. It is a ' + str(type(check)))
    exit(1)
check = secret_list_int
if not isinstance(check, list):
    print('secret_list_int is not a list. It is a ' + str(type(check)))
    exit(1)
for i in secret_list_int:
    if not isinstance(i, int):
        print('secret_list_int contains a non-int value: ' + str(i))
        exit(1)
check = secret_list_str
if not isinstance(check, list):
    print('secret_list_str is not a list. It is a ' + str(type(check)))
    exit(1)
for i in secret_list_str:
    if not isinstance(i, str):
        print('secret_list_str contains a non-str value: ' + str(i))
        exit(1)
